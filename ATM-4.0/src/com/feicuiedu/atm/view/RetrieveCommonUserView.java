 ...
 *
 */
public class RetrieveCommonUserView implements AdminBusiness {
	
	/*public static void main(String[] args) {
		new RetrieveCommonUserView().display();
	}*/

	@Override
	public void display() {

		System.out.println("所有的普通用户：");
		
		UserService us = new UserService();
		ViewUtil vu = new ViewUtil();
		Scanner scanner = new Scanner(System.in);
		
		ArrayList<Users> userArr = us.getCommonUser();
